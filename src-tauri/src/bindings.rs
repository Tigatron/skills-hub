...
pub(crate) fn builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            crate::commands::diagnostics::diagnostics_debug_set,
            crate::commands::diagnostics::diagnostics_export_prepare,
            crate::commands::diagnostics::diagnostics_export_save,
