...
| SCN-04 | P0 | [Scanning and reconciliation](workflows/scanning-and-reconciliation.md), [Filesystem safety](security/filesystem-safety.md) | Path policy in [M0-002](plans/m0-tasks-01-foundation.md); global scan in [M0-004](plans/m0-tasks-02-thin-slice.md); Workspace complete in [M0-010](plans/m0-tasks-03-breadth.md) | Global and Workspace link escape/cycle/read-only fixtures pass; M0-015 hardening remains |
| SCN-05 | P0 | [Scanning and reconciliation](workflows/scanning-and-reconciliation.md), [Tauri and UI state](interfaces/tauri-and-ui-state.md) | Workspace commands complete in [M0-010](plans/m0-tasks-03-breadth.md); Settings UI in [M0-014](plans/m0-tasks-03-breadth.md) | Add/update/pause/remove/rescan, identity replacement, and idempotence tests pass |
| SCN-06 | P0 | [Scanning and reconciliation](workflows/scanning-and-reconciliation.md) | Complete in [M0-010](plans/m0-tasks-03-breadth.md) | Nested Git/worktree, implicit adapter, standalone/manual, nearest-owner, and deterministic-order fixtures pass |
| SCN-07 | P0 | [Scanning and reconciliation](workflows/scanning-and-reconciliation.md) | Complete in [M0-010](plans/m0-tasks-03-breadth.md) | Ignore/prune/depth fixtures and property tests pass; acceptance criterion 3 |
| SCN-08 | P1 | [Scanning and reconciliation](workflows/scanning-and-reconciliation.md), [Runtime and modules](architecture/runtime-and-modules.md) | Complete in [M0-010](plans/m0-tasks-03-breadth.md) | Watcher coalescing, fault/requeue, proactive-reason, targeted/full reconciliation tests pass |
| SCN-09 | P1 | [Scanning and reconciliation](workflows/scanning-and-reconciliation.md) (diagnostics) | Activity diagnostics in [M0-008](plans/m0-tasks-02-thin-slice.md); coverage model complete in [M0-010](plans/m0-tasks-03-breadth.md); UI in [M0-014](plans/m0-tasks-03-breadth.md) | Complete/incomplete/stale/missing/replaced coverage tests pass; M0-014 rendering remains |
...
| DEL-02 | P0 | [Operation model](domain/operation-recovery-and-trash.md) | Complete in [M0-013](plans/m0-tasks-03-breadth.md) | Active-deployment no-plan blocker and exact move/restore tests pass |
| DEL-03 | P0 | [Operation model](domain/operation-recovery-and-trash.md) | Complete in [M0-013](plans/m0-tasks-03-breadth.md) | 30-day, never, expiry, and protected-reference tests pass |
| DEL-04 | P0 | [Operation model](domain/operation-recovery-and-trash.md), [Filesystem safety](security/filesystem-safety.md) | Complete in [M0-013](plans/m0-tasks-03-breadth.md) | Trash-only exact delete, confirmation, object/history retention tests pass; hardening in M0-015 |
